...
**Client Deployment**:
An Orca Memory Service installation whose host is not the synchronized authorized processor. It captures and recalls but cannot process, retain, or apply.
_Avoid_: local service

**Processor Deployment**:
The single Orca Memory Service installation whose host identity matches synchronized processor authority. It performs periodic derivation and governed apply.
...
**AgentCairn**:
A replaceable local indexing and retrieval backend derived from synchronized Markdown. It never establishes memory authority.
_Avoid_: Orca, canonical store
