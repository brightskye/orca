...
**Related specification:** [Capture Pipeline](../specifications/capture.md)
...
**Related specifications:** [Capture Pipeline](../specifications/capture.md), [Security and Trust](../architecture/README.md#security-and-trust)
...
**Related specification:** [Processing Pipeline](../specifications/processing.md)
...
**Related specification:** [Provenance Ledger](../specifications/provenance.md)
...
**Related specification:** [Memory Model](../specifications/memory.md)
...
**Related specifications:** [Memory Model](../specifications/memory.md), [Knowledge Candidates](../specifications/knowledge-candidates.md)
...
**Related specification:** [Interaction Preferences](../specifications/interaction-preferences.md)
...
**Related specification:** [Interaction Guidance](../specifications/interaction-guidance.md)
**Required evidence:** deterministic golden-template and precedence tests

### TEST-REC-001 — Scoped recall filters before ranking and stays bounded
...
**When** an Owner- or agent-initiated Recall Request is executed
...
An unmapped, unscoped request must fail before ranking. Mapped CLI recall must
stay within that project; explicit General and Unassigned requests must remain
separate. An exact conversation request must retain its continuation ahead of
related mentions, including with a one-result limit.

**Related requirements:** REQ-REC-001, REQ-AUTH-002, REQ-SAFE-001
**Related specification:** [Retrieval Contract](../specifications/retrieval.md)
...
**Related specifications:** [Retrieval Contract](../specifications/retrieval.md), [Integration Architecture](../architecture/integrations.md)
...
**Related specification:** [Configuration](../specifications/configuration.md)
...
**Related specifications:** [Memory Model](../specifications/memory.md), [Configuration](../specifications/configuration.md)
...
**Related specifications:** [Runtime](../specifications/runtime.md), [Configuration](../specifications/configuration.md)
...
**Related specification:** [Runtime](../specifications/runtime.md)
...
The controlled conversation must include a discussed choice and reason, a
tentative idea, an open question, and a next step. In a new Codex session, the
Owner must be able to resume using that stored context without repeating the
discussion. A separate case must show Codex choosing scoped recall when the
current request needs earlier context. Verify the returned sources and that
tentative ideas remain tentative. Startup instructions alone do not prove this
agent behavior; synthetic retrieval tests alone do not prove summary usefulness.

**Related requirements:** REQ-AUTH-001, REQ-AUTH-002, REQ-AUTH-003, REQ-QUAL-001
**Related specifications:** [Specification Index](../specifications/README.md), [Architecture Overview](../architecture/README.md)
...
**Related specifications:** [Memory System Contract](../specifications/memory-system-contract.md), [Security and Trust](../architecture/README.md#security-and-trust)
...
**Related specifications:** [Specification Index](../specifications/README.md), [Runtime specification](../specifications/runtime.md)
...
- every scenario above has a `pass` verdict for the evaluated revision with retained evidence;
...
- required procedures in the [Phase 1 Local Runbook](../operations/runbook.md)
...
The Owner accepted Phase 1 on 2026-08-31 based on the evidence available then.
The later readiness findings in [Current](../project-record/current.md) remain
unresolved; that historical acceptance is neither current deployment clearance
nor proof that version `0.1.0` was released.

## Existing evidence boundary

The then-current 185-test command passed on 2026-08-30. That historical run covered the
deterministic modules plus an isolated synthetic process/restart/
...
explicit Recall, and reconciled scenario record supported the Owner's
2026-08-31 acceptance. They do not resolve the later findings listed in
...
- **Roadmap:** [Phase 1](../project-record/roadmap.md#phase-1)
- **Implementation sequence:** [Phase 1 Implementation Plan](../project-record/plans/completed/phase-1-implementation.md)
- **Requirements:** [Orca Requirements](../specifications/requirements.md)
