...
[Current](../project-record/current.md) owns implemented capabilities and known
capture defects. This specification defines required behavior; it is not proof
of deployed privacy protection.
...
- **Requirements:** [REQ-CAP-001 through REQ-CAP-003](requirements.md#capture-and-privacy)
...
- **Next interface:** [Processing Pipeline](processing.md)
- **Receipts:** [Provenance Ledger](provenance.md)
