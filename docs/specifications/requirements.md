...
### REQ-REC-001 — Bounded conversation recall

Recall must help a later Codex session continue a prior discussion. The Owner
may request it actively, or Codex may invoke it when earlier context is relevant.
Both paths use the same scoped interface; startup must not preload arbitrary
history. An exact conversation request must return usable continuation content.
Recall must apply
...
- **Specification registry and ownership:** [Specification Index](README.md)
- **Authority, privacy policy, canonical behavior, and local-data constraints:** [Memory System Contract](memory-system-contract.md)
- **Capture and privacy handoff:** [Capture Pipeline](capture.md)
- **Bounded semantic processing:** [Processing Pipeline](processing.md)
- **Memory identities, records, conflicts, layout, and naming:** [Memory Model](memory.md)
...
- **Explicit bounded recall:** [Retrieval Contract](retrieval.md)
- **Interaction observations and profiles:** [Interaction Preferences](interaction-preferences.md)
- **Compiled interaction guidance:** [Interaction Guidance](interaction-guidance.md)
- **Host and vault configuration:** [Configuration](configuration.md)
- **Worker, catch-up, and attention:** [Runtime](runtime.md)
- **Backup and staging:** [Backup](backup.md)
