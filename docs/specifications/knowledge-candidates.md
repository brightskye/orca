...
defined by the [Memory Model](memory.md). It does not authorize canonical
...
3. Exact source history and candidate disposition receipts MUST remain in the
   [Provenance Ledger](provenance.md), not in unbounded candidate arrays.
...
[REQ-CAND-001](requirements.md#req-cand-001--knowledge-candidate-boundary)
...
- The schema, `knowledge/` placement, terminal lifecycle, and retention rule
  remain consistent with this specification's retention and disposition rules.
...
- **Requirements:** [REQ-CAND-001](requirements.md#req-cand-001--knowledge-candidate-boundary)
- **Authority:** [Memory System Contract](memory-system-contract.md)
