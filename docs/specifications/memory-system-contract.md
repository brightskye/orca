...
|---|---|
| Stable project obligations | [Requirements](requirements.md) |
| Component and trust structure | [Architecture Overview](../architecture/README.md) and [Security and Trust](../architecture/README.md#security-and-trust) |
| Capture, privacy filtering, redaction, and retry handoff | [Capture Pipeline](capture.md) |
| Bounded processing and proposal validation | [Processing Pipeline](processing.md) |
| Memory records, summaries, conflicts, identity, and placement | [Memory Model](memory.md) |
| Ordinary candidate lifecycle and disposition | [Knowledge Candidates](knowledge-candidates.md) |
| Run Manifests, deduplication, and checkpoints | [Provenance Ledger](provenance.md) |
| Interaction observations, profiles, and guidance | [Interaction Preferences](interaction-preferences.md) and [Interaction Guidance](interaction-guidance.md) |
| Scoped Recall and retrieval projections | [Retrieval Contract](retrieval.md) |
| Host and vault configuration | [Configuration](configuration.md) |
| Lifecycle coordination and human attention | [Runtime](runtime.md) |
| Backup and staging behavior | [Backup](backup.md) |
| Executable local procedures | [Phase 1 Local Runbook](../operations/runbook.md) |

## Related documents

- **Documentation map:** [Documentation Index](../README.md)
- **Project scope:** [Project Charter](../project.md)
- **Required behavior:** [Requirements](requirements.md)
- **Current architecture:** [Architecture Overview](../architecture/README.md)
- **Current implementation state:** [Current Status](../project-record/current.md)
- **Canonical-apply rationale:** [ADR-0011](../project-record/decisions/0011-keep-automatic-canonical-apply-disabled.md)
