...
> [Phase 1 Local Runbook](../../operations/runbook.md).

> [!NOTE]
> Runtime architecture moved to
> [`02-architecture/runtime.md`](../../architecture/runtime.md). This file remains
...
> The [proposed Phase 1 Local Runbook](../../operations/runbook.md) extracts only
...
> the [Configuration Specification](../../specifications/configuration.md). This
...
[Provenance Ledger Specification](../../specifications/provenance.md).
...
[Interaction Guidance Specification](../../specifications/interaction-guidance.md). Conflicting
