...
> [`docs/02-architecture/`](../../architecture/README.md).
...
- **Storage module**: validates artifact locations and formats, then provides
  ...
  [Memory Model Specification](../../specifications/memory.md). It also publishes `v4+`
  ...
  the [Provenance Ledger Specification](../../specifications/provenance.md).
