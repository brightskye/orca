...
The [Processing Pipeline](processing-pipeline.md) owns operation meaning. This
...
2. new writers must use `0.2` after the accepted implementation lands;
3. new checkpoints switch to `0.2` after the first successful `0.2` run; and
4. `0.1` writer support may be removed only after tests prove every active
   writer uses `0.2`.
...
- **Memory identities:** [Memory Model](memory-model.md)
- **Runtime recovery:** [Runtime Architecture](../02-architecture/runtime.md)
- **Quality:** [Acceptance Plan](../07-quality/acceptance.md) and [Test Strategy](../07-quality/test-strategy.md)
- **Accepted proposal record:** [RFC-0001](../05-proposals/0001-strengthen-run-manifest-provenance.md)
