...
Ledger](../../specifications/provenance.md) owned
...
Pipeline](../../specifications/processing.md) owns oversized-turn
segmentation and semantic operation meaning. The [Memory
Model](../../specifications/memory.md) makes `memory_id` the Typed Memory
Record audit join.
...
- **Affected accepted owners:** [Provenance Ledger](../../specifications/provenance.md), [Processing Pipeline](../../specifications/processing.md), and [Memory Model](../../specifications/memory.md)
