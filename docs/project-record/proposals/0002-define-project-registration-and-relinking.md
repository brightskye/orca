...
The [Glossary](../../specifications/glossary.md) owns Project Identity, Project
Alias, Project Registry, and Project Root Mapping terms. The [Memory
Model](../../specifications/memory.md) owns `project.md`, the Project
Registry, and project directory layout. [Configuration](../../specifications/configuration.md)
...
- **Terms:** [Glossary](../../specifications/glossary.md)
- **Affected accepted owners:** [Memory Model](../../specifications/memory.md) and [Configuration](../../specifications/configuration.md)
