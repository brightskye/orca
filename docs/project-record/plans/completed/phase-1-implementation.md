...
state belongs in [Current Status](../../current.md).
...
- The Phase 1 [Requirements](../../../specifications/requirements.md),
  [Architecture](../../../architecture/README.md),
  [Specification Index](../../../specifications/README.md), and
  [Memory System Contract](../../../specifications/memory-system-contract.md) remain
  accepted.
- A private vault path is supplied through the accepted
  [Configuration](../../../specifications/configuration.md) boundary; no
...
[Current Status](../../current.md) owns the detailed snapshot.

## Traceability

| Milestone | Requirements | Owning specifications or architecture |
|---|---|---|
| All milestones | REQ-AUTH-001, REQ-AUTH-002, REQ-AUTH-003, REQ-SAFE-001 | [Memory System Contract](../../../specifications/memory-system-contract.md), [Security and Trust](../../../architecture/README.md#security-and-trust) |
| 1 — Complete capture | REQ-CAP-001, REQ-CAP-002, REQ-CAP-003, REQ-SAFE-001 | [Capture Pipeline](../../../specifications/capture.md), [Security and Trust](../../../architecture/README.md#security-and-trust) |
| 2 — Add typed memory and project summaries | REQ-MEM-001, REQ-MEM-002, REQ-MEM-003, REQ-PROC-002, REQ-PROC-003 | [Memory Model](../../../specifications/memory.md), [Provenance Ledger](../../../specifications/provenance.md) |
| 3 — Complete processing, provenance, and candidates | REQ-PROC-001, REQ-PROC-002, REQ-PROC-003, REQ-AUD-001, REQ-CAND-001 | [Processing Pipeline](../../../specifications/processing.md), [Knowledge Candidates](../../../specifications/knowledge-candidates.md), [Provenance Ledger](../../../specifications/provenance.md) |
| 4 — Implement interaction behavior | REQ-INT-001, REQ-INT-002 | [Interaction Preferences](../../../specifications/interaction-preferences.md), [Interaction Guidance](../../../specifications/interaction-guidance.md) |
| 5 — Implement explicit recall | REQ-REC-001, REQ-REC-002, REQ-SAFE-001 | [Retrieval Contract](../../../specifications/retrieval.md), [Integration Architecture](../../../architecture/integrations.md) |
| 6 — Wire configuration and local runtime | REQ-OPS-001, REQ-OPS-002, REQ-OPS-003, REQ-CAP-003 | [Configuration](../../../specifications/configuration.md), [Runtime Architecture](../../../architecture/README.md#runtime), [Deployment Architecture](../../../architecture/deployment.md) |
| 7 — Verify Phase 1 readiness | REQ-QUAL-001 and all Phase 1 requirements | [Roadmap Phase 1 exit criteria](../../roadmap.md#phase-1), [Current Status](../../current.md) |
...
[Acceptance Plan](../../../quality/acceptance.md),
[Test Strategy](../../../quality/test-strategy.md), and
[Phase 1 Local Runbook](../../../operations/runbook.md) remain the evidence and
...
- Keep deterministic tests, semantic evaluations, and deployment evidence
  separately labelled.
- Update [Current Status](../../current.md) only after implementation evidence is
...
- **Decisions:** [Decision Registry](../../decisions/README.md)
